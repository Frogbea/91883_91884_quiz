...
def instructions():
    ...
    # print instructions
    print('Hello, this will be a multiplication quiz, you can choose the skill level, there are three options. \n There will be 10 questions and at the end you will get a score out of ten, depending on how many questions you get right. \n Please only answer with numbers. Good Luck! ')
...
def player_level():
    ...
    while True:
        try:
            # asks user question
            user_level = int(input('What number range would you like to practice? type in 1 for [1 - 10] | type in 2 for [10 - 20] | type in 3 for [10 - 99]:'))
...
while loop_game:
    ...
    while loop_game:
        ...
        # if yes start game again
            ...
            break
        # if not no or yes show error and ask question again
        else:
